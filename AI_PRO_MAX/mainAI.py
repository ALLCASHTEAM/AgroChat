...
def AI_COMPIL(question: str) -> str:
    ...
    tokens = answer[1]
    answer = answer[0].replace("GPT4", "").replace("GPT:", '', 1).replace("Answer:", "").replace("Agrochem", 'Агрохим').replace("Context:", "").replace("GPT 4:", "").replace("GPT-4:", "").replace("GPT", "").replace("GBT4:", "")
